...
const ABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256[]", name: "feedCosts", type: "uint256[]" },
      { internalType: "uint256[]", name: "revenueModes", type: "uint256[]" },
    ],
    name: "createNewFeeds",
    outputs: [],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "uintValue", type: "uint256" },
  ...
  {
    inputs: [{ internalType: "uint256", name: "feedID", type: "uint256" }],
    name: "getFeed",
    outputs: [
  ...
  {
    inputs: [{ internalType: "uint256[]", name: "feedIDs", type: "uint256[]" }],
    name: "getFeedList",
    outputs: [
  ...
  {
    inputs: [
      { internalType: "uint256[]", name: "feedIDs", type: "uint256[]" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "signerThreshold_", type: "uint256" },
      {
      ...
      { internalType: "address", name: "factoryContract_", type: "address" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "proposalType", type: "uint256" },
      { internalType: "uint256", name: "proposalFeedId", type: "uint256" },
      { internalType: "uint256", name: "proposalActive", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
